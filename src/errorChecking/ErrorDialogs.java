...
/**
 * A class that displays error dialogs to the user. Basically, instead
 * of halting and catching on fire, this program will (hopefully)
 * identify the error and safely exit from the subsection.
 * @author RehdBlob
 * @since 1.04
 * @since 2011.0809
 */
