...
/**
 * A main menu class for the MPCTxtTools program. This is the first
 * step into using the platform-independent awt class, the first in the
 * line of a large number of revamps to the program. Once completed, the
 * program will have much more intuitive functionality, a more aesthetic 
 * appearance, and overall will be better.
 * @author RehdBlob
 * @since 1.06
 * @since 2011.1117
 *
...
public class MainMenu {
	 ...
	 * @since 2011.1205
	 * 
	 * @param s The title that the main menu should take on.
	 */
